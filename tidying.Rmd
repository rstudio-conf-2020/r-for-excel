...
"Tidy" might sound like a generic way to describe non-messy looking data, but it is actually a specific data structure 
...
We see that the resulting data frame has split *site_year* into two separate columns, *sample_year*, *location*, and *sp_name*, but now everything after the second break ("-") remains together in *sp_name* instead of dropping pieces following the third word. 
