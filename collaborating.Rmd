...
TODO: swap out gh-pages screenshots
...
Helping you help yourself means moving beyond "it's not working" and towards solution-oriented approaches. Part of this is the mindset where you **expect that someone has encountered this problem before** and that **most likely the problem is your typo or misuse**, and not that R is broken or hates you. 
...
And then when I also have this in my clipboard. Now I am going to paste it into an [Issue for our r-for-excel repository](https://github.com/rstudio-conf-2020/r-for-excel/issues) 
...
So in this example I might write at the top of the comment "allison_horst how do I change the point color to cyan?" And when Allison is tagged
...
Make a reprex using the built-in `iris` dataset and paste it in the Issues for your repository. (Have a look at iris: `head(iris); summary(iris)`)

1. For your reprex, take the iris dataset and then filter it for observations where the Petal.Length is more than 6.5

2. Navigate to github.com/your_username/r-workshop/issues

Hint: remember to read the error message. "could not find function `%>%`" means you've forgotten to attach a package with `library()`
...
Now, Partners 1 and 2, both go to the README.md, and on Line 7, write something, anything. Save the README. 
...
knitr::include_graphics("img/github_mergeconflict2.png")  
```
...
knitr::include_graphics("img/github_mergeconflict3.png")  
```
...
1. Go to GitHub.com and go to your rendered website! Where is it? Figure out your website's url from your github repo's url — pay attention to urls. For example: 
