...
Troubleshooting: if you duplicate the same label name, you will see an error when you try to knit: 
...
It is important to be able to run R code directly rather than only executing it when you knit the document. 
...
> Troubleshooting: The following error is because you also highlighted and asked to run , and this is the code fencing, not R code itself.
