...
Launch RStudio. You will probably never open R by itself. When you open RStudio it brings R along with it. 
...
- `summary(cars)` produces a table
- `plot(pressure)` produces a plot 

There are a couple of things going on here. 

`summary()` and `plot()` are called functions; they are operations and these ones come built-in to R. This is similar to how Excel has operations and formulas. `cars` and `pressure` are small datasets that come installed with R. 
...
This set up is a one-time thing! You will only have to do this once per computer. We'll walk through this together. **You will need to remember your GitHub username, the email address you created your GitHub account with, and your GitHub password.** In a browser, go to github.com and to your profile page as a reminder.
...
If you see this error: `Error in use_git_config(x) : could not find function "use_git_config"` please run `library("usethis")`

### Ensure that Git/GitHub/RStudio are communicating

To ensure that GitHub and TODO
