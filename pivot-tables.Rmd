...
- shorten data exploration
- shorten skimr install: “oh no, we don’t have ‘skimr’, looks like we need to install it cool.”
- add data source
- TODO: add blank lines to lobsters and then use read_xlsx(skip =)
...
- [Broman & Woo: Data organization in spreadsheets](https://peerj.com/preprints/3183/)
