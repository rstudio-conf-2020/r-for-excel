...
Since the GitHub session (Chapter \@ref(github)), we have been practicing using GitHub with RStudio to collaborate with our most important collaborator: Future You. Here we will practice using GitHub with RStudio to collaborate with others now, with a mindset towards Future Us. We will also how to engage with the R community broadly and how to continue being a part of the #rstats community, including how to engage on Twitter, and how to ask for help. 
...
http://sfirke.github.io/janitor/reference/excel_numeric_to_date.html
