...
**Task:** Create a new object called 'inverts_moyr', starting from inverts_wide, that unites the month and year columns into a single column named "mo_yr", using a dash "-" as the separator. Then try updating the separator to something else! Like "_hello!_".

**Solution:**
```{r}
inverts_moyr <- inverts_wide %>% 
...
**Task:** Create a new object called **in_detect**, starting from **inverts**, that only contains observations if the **common_name** variable contains the string pattern "in". What species remain?
