...
In this case, you **read the error message** to identify the problem: "duplicate label 'cars'". 
...
What is `plot` anyways? It is a function.

## Functions
 
*TODO, this is a placeholder. Do c().*
