...
Hello! This is a workshop taught by Dr. Julie Stewart Lowndes and Dr. Allison Horst at the RStudio Conference: January 27-28 in San Francisco, California. 

```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("img/r-for-excel-monsters.jpg")  
```

We are environmental scientists who use and teach R in our daily work. We both work at the University of California Santa Barbara. 

Julie is a Senior Fellow and Director of Openscapes at the National Center for Ecological Analysis and Synthesis. 

Allison is a lecturer of data science & statistics at the Bren School of Environmental Science and Management. She is Artist in Residence at RStudio!
...
**Short URL for this book**:   <https://rstd.io/conf20-r-excel>  
**GitHub repo for this book**: <https://github.com/rstudio-conf-2020/r-for-excel>
...
|break      |  | |
|11-12:30   | [Intro to GitHub](#github) (JL) | [Filters & joins](#filters) (AH) |
|lunch      |  ||
|13:30-15:00 | [Graphs with `ggplot2`](#ggplot2) (AH) | [Collaborating & getting help](#collaboration) (JL) |
|break      |  | |
|15:30-17:00 | [Pivot Tables & `dplyr`](#dplyr-pivot-tables) (JL) | [Synthesis](#synthesis) (AH) |
